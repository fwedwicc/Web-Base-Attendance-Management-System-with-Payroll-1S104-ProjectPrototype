...
<head>
    ...
    <title>Admin Page  I  Dashboard</title>
</head>
<body>
    <div id="container">
        <div id="panel1">
            <div id="content1">
                ...
                <br>
                <hr>
                <a href="admin_registration.php" id="efct2">Register Account</a>
                <hr>
                <a href="admin_employee's_attendance.php" id="efct3">Emloyee's Attendance</a>
                <hr>
            </div>
        </div>
        <div id="panel2">
