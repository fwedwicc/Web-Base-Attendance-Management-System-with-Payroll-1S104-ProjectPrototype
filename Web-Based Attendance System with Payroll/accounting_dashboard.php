...
<head>
    ...
    <title>Accounting Page  I  Dashboard</title>
</head>
<body>
    <div id="container">
        <div id="panel1">
            <div id="content1">
                ...
                <br>
                <hr>
                <a href="accounting_view_salary.php" id="efct2">View Employee's Salary</a>
                <hr>
                <a href="accounting_employee's_attendance_view.php" id="efct3">View Employee Attendance</a>
                <hr>
            </div>
        </div>
        <div id="panel2">
